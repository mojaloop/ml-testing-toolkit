...
Options:
  ...
  -i, --input-file <inputFile>        required when the mode is "outbound" --- supported formats: "json"
...
reportName:
  - reportFormat is json: ${test-name}-${date-now}.json
  - reportFormat is html/printhtml format: value is generated by the service responsible for converting the json to the given format
