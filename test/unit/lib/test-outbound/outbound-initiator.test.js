...
describe('Outbound Initiator Functions', () => {
  ...
  describe('sendRequest', () => {
    ...
    it('sendRequest should call axios with appropriate params 9 and with CLIENT_MUTUAL_TLS_ENABLED', async () => {
      ...
      try {
        await OutboundInitiator.sendRequest('localhost:5000/', 'post', '/quotes', null, sampleRequest.headers, sampleRequest.body, null, null, null, 'notExistingDfsp')
      } catch (err) {}
    })
    it('sendRequest should call axios with appropriate params 10 and with http and https urls', async () => {
      ...
      try {
        await OutboundInitiator.sendRequest('http://localhost:5000/', 'post', '/quotes', null, sampleRequest.headers, sampleRequest.body, null, null, null, 'notExistingDfsp')
        await OutboundInitiator.sendRequest('https://localhost:5000/', 'post', '/quotes', null, sampleRequest.headers, sampleRequest.body, null, null, null, 'notExistingDfsp')
      } catch (err) {}
    })
